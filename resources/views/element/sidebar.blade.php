<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        <li class="nav-item nav-profile">
            <div class="nav-link">
                <div class="profile-image">
                    <img src="{{asset('accounts/images/faces/face5.jpg')}}" alt="image"/>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link" href="addwallet.html">
                <i class="fa fa-puzzle-piece menu-icon"></i>
                <span class="menu-title">Add Wallet Address</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link"  href="updateprofile.html" >
        ...
        <li class="nav-item">
            <a class="nav-link"  href="miningplan.html">
                <i class="far fa-handshake menu-icon"></i>
                <span class="menu-title">Purchase Plan</span>
        ...
        <li class="nav-item">
            <a class="nav-link"  href="invthistory.html">
        ...
        <li class="nav-item">
            <a class="nav-link"  href="passreset.html" >
